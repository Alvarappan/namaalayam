...
- Deep rich detail (mythology, architectureFeatures, subShrines, visitorLogistics, sevas, faqs) for the remaining 3 temples in `templeDetails.ts` (kapaleeswarar-mylapore and arunachaleswarar-thiruvannamalai have basic entries but still need the optional rich fields; kesava-somnathpur has no entry yet).
