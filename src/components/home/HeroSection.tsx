  ...
  return (
    <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-stone-700 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
        ...
        <div className="relative max-w-2xl mx-auto">
          <div className="flex items-center bg-white rounded-2xl shadow-xl shadow-orange-300/30 ring-1 ring-amber-200/60 overflow-hidden">
            ...
            />
            <button className="m-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold rounded-xl hover:from-orange-600 hover:to-amber-600 transition-all duration-200 whitespace-nowrap">
              Search
            </button>
          </div>
